...
https://devapi.vwbeatroute.com/v1/sales-log/index?key=RIbVA7NRrZ6DdQQS1P7mtZTWOJND_hxU&from_date=2022-08-01 00:00:00&to_date=2022-09-05 15:02:40&page=N
```
...
brSku.details.map((obj, i) => {
    if (i !== 0) {
        ...
        //newRequirement.order_id = brSku.orderId;
        newRequirement.details.item.push(quantityUpdate1);
      }
      });
} else {
